...
public class FavoriteServlet extends HttpServlet {
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        // request.getReader() --> read JSon body
        // use mapper to convert body from JSon string to Object
        FavoriteRequestBody body = mapper.readValue(request.getReader(), FavoriteRequestBody.class); // .class: tell the destination type
        if (body == null) {
        ...
        try {
            ...
            // add to FavoriteItem table in data base
